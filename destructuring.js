...
// console.log(doubleIt(2, 3)); // generally when we exicute the function like this we get the answer as an array. but then with distructuring method it will store the two components of array with the name of variebles that we call.
